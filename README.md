...
- Printing for the Link and Node objects (66%).
  ...
  - Complete Link print-object.
  - Introduce function to dump properties. [DONE]
- Put everything in a package and select the exported functions. [On-track]
  Note: Created the package and exported the desired already existing functions (get-keys, node-create, link-create, node-match, get-prop, set-prop, dump-props)
